        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <?php if ($role == 0): ?>
                <li class="menu-item">
                  <a href="manage-department.php" class="menu-link">
                    <div data-i18n="Department">Manage Department</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="manage-role.php" class="menu-link">
              ...
              <?php if ($role == 1): ?>
                ...
                <li class="menu-item">
                  <a href="emp-leave.php" class="menu-link">
                    <div data-i18n="Employee Leave">Employee Leave</div>
                  </a>
                </li>
              <?php endif; ?>
              ...
              <?php if ($role == 2):?>
                  <li class="menu-item">
                    <a href="project-managment.php" class="menu-link">
                      <div data-i18n="Project Managment">Project Managment</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="project-status.php" class="menu-link">
              ...
              <?php if ($role == 3):?>
                <li class="menu-item">
                  <a href="emp-profile.php" class="menu-link">
